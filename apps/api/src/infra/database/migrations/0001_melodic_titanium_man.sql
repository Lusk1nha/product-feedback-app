...
ALTER TABLE "feedbacks" ALTER COLUMN "updated_at" SET DATA TYPE timestamp with time zone;--> statement-breakpoint
ALTER TABLE "feedbacks" ALTER COLUMN "updated_at" SET DEFAULT now();--> statement-breakpoint
